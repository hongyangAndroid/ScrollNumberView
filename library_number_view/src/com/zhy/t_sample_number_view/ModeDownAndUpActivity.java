...
public class ModeDownAndUpActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setTitle("Mode : DOWM_AND_UP , 7->1");
		mAutoScrollViewNumberView = (AutoScrollTextView) findViewById(R.id.id_scroll_text);
		mAutoScrollViewNumberView.setMode(Mode.DOWN_AND_UP);
		...
		mAutoScrollViewNumberView.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				setTitle("Mode : DOWM_AND_UP , "+start+" -> " +end);
